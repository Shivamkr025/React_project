...
import banner from './Assets/banner/woman_banner02.jpg'
...
function Womans () {
    ...
    const womanProduct = products.filter(product => product.category === "woman clothes")
    ...
    return (
        ...
        <div className='row row-cols-1 row-cols-md-3 g-4'>
            {womanProduct.slice(0,9).map((product, index) => (

                <div className='col' key={index}>
                    <div className='card shadow-sm m-4' style={{width:'88%'}}>
                        <img src={product.imageUrl} alt={product.productName} className='bd-placeholder-img card-img-top d-flex' height='400' />
